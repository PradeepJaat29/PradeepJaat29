...
<style>
  ...
  *{box-sizing:border-box; margin:0; padding:0;}
  ...
  .eyebrow{
    ...
    text-shadow:0 0 10px rgba(255,61,240,0.35);
  }
  .eyebrow::before{
    content:"";
  ...
  .project-body li strong{color:var(--accent-2);}
      ...
      <div class="project">
        ...
        <div class="project-body">
          ...
          <ul>
            ...
            <li>Presented the project at <strong>ICSAS 2026</strong>, demonstrating its practical application.</li>
          </ul>
        </div>
      </div>
